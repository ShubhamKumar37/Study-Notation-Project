...
const Section2 = () => {
  return (
    <div className='text-white flex flex-col gap-[5rem]'>
        <div className='flex gap-[5rem]'>
            <p className='w-[45%]'>
                <ColorText text={"Our Founding Story"} color={"Color-Text-1"}/>
        ...
        <div className='flex flex-row gap-[5rem]'>
            <div className='flex flex-col w-[45%]'>
                <h1>
                    <ColorText text={"Our Vision"} color={"Color-Text-2"} />
                </h1>
            ...
            <div className='flex flex-col w-[45%]'>
                <h1>
                    <ColorText text={"Our Mission"} color={"Color-Text-3"} />
