...
const CodeBlocks = ({ position, heading, subHeading, btn1, btn2, codeBlock, gradient, codeColor }) => {
    return (
        <div className={`flex flex-col ${position} my-20 justify-between gap-10`}>
            ...
            {/* Section 2 */}
            <div className=' relative text-center flex flex-row sm:w-[40%] text-richblack-500 font-inter font-bold h-fit bg-richblack-800 border bg-opacity-40 border-richblack-800 gap-2'>
