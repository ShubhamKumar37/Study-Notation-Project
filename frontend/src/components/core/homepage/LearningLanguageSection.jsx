...
const LearningLanguageSection = () => {
    return (
        <div className='relative bg-[#F9F9F9] py-[5rem] pt-[10rem]'>
            <div className='relative w-11/12 mx-auto flex flex-col items-center gap-[1.5rem]'>
                <div className='text-center flex flex-col gap-2'>
                    ...
                    <div className='text-center'>
                        <p className='w-[80%] mx-auto font-medium text-[16px]'>
                ...
                <div className='flex flex-row '>
                    <img src={Image1} alt='know-your-progress' className='relative object-contain w-[33%] left-[7rem]'/>
                    <img src={Image2} alt='compare-with-other' className='relative object-contain w-[33%] left-1' />
                    <img src={Image3} alt='plan-your-leassons' className='relative object-contain w-[33%] right-[7.5rem]' />
                </div>
